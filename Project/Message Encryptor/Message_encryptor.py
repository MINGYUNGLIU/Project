...
#First encode the message from data type string to bytes than encrypt the message. 
def encrypt_message(message):
    encrypted_message=cipher_suite.encrypt(message.encode())
    return encrypted_message

#First decrypt the bytes message , than decode the message from bytes back to string. 
